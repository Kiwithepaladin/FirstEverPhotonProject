Shader "Custom/VertexDisplacment"
{
	Properties
	{
		...
		_Postion2("Position 2", Range(0,1)) = 0
	}
		...
		Pass
		{
		 ...
		 #include "UnityCG.cginc"
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				clip(step(i.uv.y, _Postion2 * _MainTex_ST.y) - 0.1);
				return col;
			}
			ENDCG
		}
